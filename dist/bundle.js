...
var menu = function menu() {
  var navigationToggleButton = document.querySelector('.header__button-mobile');
  var menuSvgs = document.querySelectorAll('.header__toggle');
  var navigationMenu = document.querySelector('.navigation');
  var body = document.querySelectorAll('.page');

  var menuToggle = function menuToggle() {
    navigationMenu.classList.toggle('is-active');
    body[0].classList.toggle('no-scroll');
    menuSvgs.forEach(function (svg) {
...
window.addEventListener('DOMContentLoaded', function () {
  (0,_js_menu__WEBPACK_IMPORTED_MODULE_1__.menu)();
});
}();
/******/ })()
;